...
Generated 2026-09-03T16:22Z by scripts/run_all.py. **Numbers only** -- the prose,
...
| phase | title | state |
|---|---|---|
| phase6 | Phase 6: ledger v2, numbers.tex, claims map, CI checks | complete |

## Artifacts

- `results/phase_1_gate_report.md` -- present
- `results/correlation` -- present
- `results/aggregation` -- present
- `results/adversarial` -- present
- `results/claims.md` -- present
